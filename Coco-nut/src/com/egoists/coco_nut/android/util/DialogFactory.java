...
public class DialogFactory {
    ...
    /** 버튼 없는 퀵 다이얼로그 반환 **/
    public static AlertDialog.Builder createNoButton(final Activity con, int titleRes, int messageRes) {
    ...
    /** 버튼 없는 퀵 다이얼로그 반환 **/
    public static AlertDialog.Builder createNoButton(final Activity con, int titleRes, String message) {
