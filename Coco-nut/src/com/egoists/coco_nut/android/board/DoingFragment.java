...
public class DoingFragment extends Fragment {
    ...
    private ArrayList<Card> mDoingCards;
    Activity mContext;
    ...
    public void onAttach(Activity activity) {
        ...
        mListAdapter = new CardListAdapter(mContext, mDoingCards);
    }
    ...
    void requestCards() {
        EventBus.getDefault().post(new RequestDoingCardsEvent());
    }
     ...
     * @param event
     */
    public void onEvent(DoingCardsEvent event) {
        AndLog.d("Get event");
        mDoingCards = (ArrayList<Card>) event.cards;
        refreshCardList(mDoingCards);
    }
}
